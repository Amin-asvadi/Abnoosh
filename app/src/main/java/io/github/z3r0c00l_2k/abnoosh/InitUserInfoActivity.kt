...
class InitUserInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etSleepTime.editText!!.setOnClickListener {
            ...
            mTimePicker.setTitle("انتخاب زمان خواب")
            mTimePicker.show()
        }
        ...
        btnContinue.setOnClickListener {
            ...
            when {
                TextUtils.isEmpty(weight) -> Snackbar.make(it, "لطفا وزن خود را وارد نمایید", Snackbar.LENGTH_SHORT).show()
                ...
                workTime.toInt() > 500 || workTime.toInt() < 0 -> Snackbar.make(
                    ...
                    editor.apply()
                    startActivity(Intent(this, DrinkWaterActivity::class.java))
                    finish()
