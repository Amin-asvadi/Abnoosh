package io.github.z3r0c00l_2k.abnoosh.fragments
...
import io.github.z3r0c00l_2k.abnoosh.DrinkWaterActivity
import io.github.z3r0c00l_2k.abnoosh.R
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        etRingtone.editText!!.setOnClickListener {
            ...
            intent.putExtra(
                ...
                "آهنگ زنگ را برای اعلان ها انتخاب کنید:"
            )
        ...
        etWakeUpTime.editText!!.setOnClickListener {
            ...
            mTimePicker.setTitle("انتخاب زمان بیدار شدن")
            mTimePicker.show()
        }
        ...
        etSleepTime.editText!!.setOnClickListener {
            ...
            mTimePicker.setTitle("انتخاب زمان خوابیدن")
            mTimePicker.show()
        }
        ...
        btnUpdate.setOnClickListener {
            ...
            when {
                ...
                TextUtils.isEmpty(customTarget) -> Toast.makeText(
                    ...
                    Toast.makeText(mCtx, "مقادیر با موفقیت به روز شد", Toast.LENGTH_SHORT).show()
                    ...
                    dismiss()
                    (activity as DrinkWaterActivity?)!!.updateValues()
