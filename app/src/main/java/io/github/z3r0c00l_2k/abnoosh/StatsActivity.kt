...
import io.github.z3r0c00l_2k.abnoosh.utils.ChartXValueFormatter
...
class StatsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (cursor.moveToFirst()) {
            ...
            Toast.makeText(this, "خالی", Toast.LENGTH_LONG).show()
        }
        ...
        if (!entries.isEmpty()) {
            ...
            if (remaining > 0) {
                remainingIntake.text = "$remaining میلی لیتر "
            } else {
                remainingIntake.text = "0 میلی لیتر"
            }
